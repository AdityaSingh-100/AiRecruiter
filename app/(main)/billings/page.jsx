  ...
  const plans = [
    {
      ...
      period: "month",
      description:
        "Best for individuals or small teams starting with AI-powered interviews",
      icon: Zap,
      popular: false,
      credits: 100,
      features: [
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-blue-700 dark:text-blue-300 mb-4">
                Your payment is processed securely through Razorpay. We support
                all major credit cards, debit cards, UPI, and net banking.
              </p>
            </div>
          </div>
        </div>
